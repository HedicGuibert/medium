            ...
            /***/ () => {
                ...
                anchors.forEach(function (item) {
                    return item.addEventListener("click", function () {
                        ...
                        badge.innerHTML =
                            '<button type="button" class="btn btn-outline-primary btn-rounded" onclick="deleteBadge(this)" id="button_response" value="'
                                .concat(item.getAttribute("data-id"), '">')
                                .concat(
                                    item.getAttribute("data-name"),
                                    ' <i style="vertical-align: middle;" class="icon-times-circle"></i></button>'
                                );
                        form.innerHTML =
                            '<input hidden id="comment_id" name="comment_id" value="'.concat(
                                item.getAttribute("data-id"),
                                '">'
                            );
                        textArea.placeholder = "Vous r\xE9pondez \xE0 ".concat(
                            item.getAttribute("data-name")
                        );
                    });
                });
